...
public class FollowingAdapter extends RecyclerView.Adapter<FollowingAdapter.ViewHolder> {
    ...
    public FollowingAdapter(ArrayList<FollowData> data) {
        this.mData = data;
    }
    ...
    @NotNull
    @Override
    public FollowingAdapter.ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.user_item, parent, false);
        FollowingAdapter.ViewHolder viewHolder = new FollowingAdapter.ViewHolder(view);
        return viewHolder;
    }
    ...
    private FollowerAdapter.OnFollowClickListener followClickListener;

    public interface OnFollowClickListener {
        void onFollowClick(View v, int position);
    }

    public void setOnFollowClick(FollowerAdapter.OnFollowClickListener listener) {
