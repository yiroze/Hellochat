package com.example.hellochat.Adapter.Image;
...
public class BigImageAdapter extends RecyclerView.Adapter<BigImageAdapter.ViewHolder> {
    ...
    public BigImageAdapter(ArrayList<String> list, Context context) {
        mData = list;
        mContext = context;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        ...
        View view;
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.image_one, parent, false);
