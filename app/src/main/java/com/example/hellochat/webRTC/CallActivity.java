...
package com.example.hellochat.webRTC;
...
import com.example.hellochat.webRTC.AppRTCClient.SignalingParameters;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mHandler = new Handler(Looper.myLooper()) {
            ...
            public void handleMessage(@NonNull Message msg) {
                ...
                if (msg.what == 1) {
                    value++;
                    time.setText(util.secToText(value));
                    mHandler.sendEmptyMessageDelayed(1, 1000);
                } else {
                    if (isCaller) {
                        if(isConnected){
                            JSONObject jsonObject = new JSONObject();
                            Intent serviceIntent = new Intent(CallActivity.this, ClientService.class);
                            try {
                                jsonObject.put("accept_user_idx", user_idx);
                            ...
                            Log.d(TAG, "handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: handleMessage: ");
                            JSONObject jsonObject = new JSONObject();
                            Intent serviceIntent = new Intent(CallActivity.this, ClientService.class);
                            try {
                                jsonObject.put("accept_user_idx", user_idx);
