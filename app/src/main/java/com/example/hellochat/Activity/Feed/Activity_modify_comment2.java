...
public class Activity_modify_comment2 extends Activity {
    EditText editText;
    TextView ok, cancel;
            ...
            call.enqueue(new Callback<ResultData>() {
                ...
                public void onResponse(Call<ResultData> call, Response<ResultData> response) {
                    if(response.isSuccessful()){
                        Intent result = new Intent(Activity_modify_comment2.this , Activity_Reply.class);
                        result.putExtra("content" , editText.getText().toString());
